...
You can use this applicaiton by: The application will be invoked by using the following command: node index.js Answer the prompts in your command line to generate the README. After answering all the prompts, the README.md file will be ready at the repo's root.
...
## Questions
If you have any questions about the repo, contact me at: If you have any questions about the repo, contact me at: m@w.
